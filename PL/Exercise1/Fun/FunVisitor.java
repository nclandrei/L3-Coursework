...
public interface FunVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link FunParser#fun_case}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFun_case(FunParser.Fun_caseContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunParser#fun_default}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFun_default(FunParser.Fun_defaultContext ctx);
	/**
